...
Welcome to my **Power BI Portfolio**. This repository contains my best Power BI projects showcasing real-world business dashboards, data modeling, DAX measures, ETL transformations, and end-to-end analytics workflows.
...
- Detailed project-wise READMEs

This portfolio is designed so recruiters and hiring managers can quickly review my Power BI capabilities.


## 🚀 About Me
**Name:** Aditya Bhor  
**Role:** Aspiring Power BI Developer / Data Analyst  
**Skills:** Power BI Desktop, Power BI Service, DAX, Power Query, Data Modeling, SQL, Excel, Python , Data Analytics
...
- `project-repo-link.txt` — link to GitHub folder or full project page
